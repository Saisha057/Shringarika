...
export function sanitizeIfsc(ifsc) {
...
export function sanitizeAccountNumber(accountNumber) {
...
export function extractBankCode(ifsc) {
...
export function getBankNameFromIfsc(ifsc) {
  const bankCode = extractBankCode(ifsc);
  return COMMON_BANK_CODES[bankCode] || null;
}
