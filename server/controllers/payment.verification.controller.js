...
async function mockVerifyUpi(upiId) {
  // Simulate API delay
...
async function mockVerifyBank(accountNumber, ifsc) {
  // Simulate API delay
...
export async function verifyUpi(req, res) {
  try {
...
export async function verifyBank(req, res) {
  try {
    const supabase = getSupabaseAdmin();
    const userId = req.user?.id;
